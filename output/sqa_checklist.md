...
|----|----------|-------------|--------|----------|
| VA-01 | virtual_analysis | All virtual function changes identified and classified (Cat1/Cat2) | PASS | 0 modified, 0 added |
| VA-02 | virtual_analysis | All Category 2 changes scheduled for reverification | PASS | 0 Cat2 changes |
...
| STD-02 | standards | Compliance score meets minimum threshold (85%) | PASS | Score: 92.0% |